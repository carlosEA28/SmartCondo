...
var (
	...
	ErrUnauthorizedMorador     = errors.New("user is not authorized as morador")
	ErrComunicadoNotOwner      = errors.New("you can only delete your own comunicados")
	ErrAreaComumNotFound       = errors.New("area comum not found")
	ErrReservaNotFound         = errors.New("reserva not found")
	ErrReservaConflito         = errors.New("there is already a reservation for this area at the requested time")
	ErrMoradorInadimplente     = errors.New("resident has overdue payments")
	ErrReservaNotOwner         = errors.New("you can only cancel your own reservations")
	ErrInvalidReservaData      = errors.New("invalid reservation data")
)
